...
class PollEditFormViewModelTests: XCTestCase {
    private enum Constants {
        static let presenceInitialValue: PollEditFormPresence = .offline
    ...
    override func setUpWithError() throws {
        service = MockPollEditFormService(displayName: Constants.displayName, presence: Constants.presenceInitialValue)
        viewModel = PollEditFormViewModel.makePollEditFormViewModel(pollEditFormService: service)
    ...
    func testPresenceUpdatesReceived() throws {
        ...
        let newPresenceValue1: PollEditFormPresence = .online
        let newPresenceValue2: PollEditFormPresence = .idle
